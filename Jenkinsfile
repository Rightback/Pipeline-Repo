pipeline {
  ...
  post {
      success {
          mail to:"illinoix@yahoo.com","ejike2agk@gmail.com", subject:"SUCCESS: ${currentBuild.fullDisplayName}", body: "${currentBuild.currentResult}: Job ${env.JOB_NAME} build ${env.BUILD_NUMBER}\n More info at: ${env.BUILD_URL}"
        }
      failure {
